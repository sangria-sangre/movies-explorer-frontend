  ...
  return (
    <section className="about-me">
      ...
      <div className="about-me__box">
        ...
        <h2 className="about-me__subtitle">Александра</h2>
        <h3 className="about-me__caption">Фронтенд-разработчик, 23 года</h3>
        ...
        <a className="about-me__link" href="https://github.com/sangria-sangre/">Github</a>
      </div>
    </section>
  );
}
